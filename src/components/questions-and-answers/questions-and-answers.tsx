  ...
  return (
    <>
      ...
      >
        ...
        <p className="mb-2">
          <b>Explained like you're 5</b>: Imagine you have a secret toy 🧸 that
          you want to give to your friend at school, but you don't want anyone
          else to see or take it. You could just give it to your friend
          directly, but what if someone is watching? That's like sending a
          password via sms; someone might be spying and see the password.
        </p>
        <p className="mb-2">
          ...
          park later. Even if someone saw you give the box, they can't open it
          without the key!
        </p>
        <p>
          ...
          separately. This way, even if someone sees one part, they can't get
          the full secret without the other part. It's safer because it's harder
          for bad people to get both the box and the key.
        </p>
      </Accordeon>
